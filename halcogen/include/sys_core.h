...
/** @fn void _disableIrqInterrupt_(void)
*   @brief Disable IRQ Interrupt mode in CPSR register
*
*   This function disables IRQ Interrupt mode in CPSR register.
*/
void _disableIrqInterrupt_(void);
void _enableIrqInterrupt_(void);
void _enableFiqInterrupt_(void);

/** @fn void _disableFiqInterrupt_(void)
*   @brief Disable FIQ Interrupt mode in CPSR register
*
*   This function disables IRQ Interrupt mode in CPSR register.
*/
void _disableFiqInterrupt_(void);
